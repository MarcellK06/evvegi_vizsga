...
function LoginForm() {
    ...
    return (<>
        <div className="d-none d-sm-block"> <br /><br /><br /><br /><br /> <br /><br /></div>
            ...
            <div className="row">
                <div className="col-sm-4 mx-auto">
                    ...
                    <div className="input-group mb-2 mt-2">
                        <input type="email" className="form-control w-100" placeholder="Email: minta@mail.com" ref={emailRef} required />
                    </div>

                    <div className="input-group mb-2">
                        <input type="password" className="form-control w-100" ref={passwordRef} placeholder="Jelszó" required />
                    </div>
                    ...
                    <div className="input-group mb-2">
                        <input type="button" value="Bejelentkezés" className="login-button form-control w-100" onClick={HandleLogin} />
                    </div>
                </div>
            </div>
        </div>
