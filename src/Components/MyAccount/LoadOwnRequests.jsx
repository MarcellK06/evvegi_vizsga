  ...
  const LoadAnswers = (el) => {
    ...
    return (
      <div className="postcolor my-3">
          ...
          <div className="col-10">
            ...
            <div className="row my-2">
              ...
              <textarea
                ...
                rows={5}
                ref={responseRef}
                value={el.response == null ? "VÁLASZRA VÁR" : el.response}
                disabled
              />
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-2 ms-auto text-end mx-3">
    ...
    $.ajax({
      ...
      success: (resp) => {
        ...
        resp.forEach((i) => {
          ...
          rs.push(
            new Request(title, description, vin, answered, data, date, response)
          );
        });
        setRequests(rs);
      },
  ...
  return (
    <>
      <div className="row my-3">
        ...
        <div className="col-8">{requests.map((i) => LoadAnswers(i))}</div>
        <div className="col-2"></div>
      </div>
    </>
  );
